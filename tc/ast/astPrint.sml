signature AST_PRINT = sig val print : TextIO.outstream * AST.exp -> unit end
structure ASTPrint: AST_PRINT = struct
 structure A = AST
 ...
 fun print (out,e0) =
  let
   ...
   fun opname A.PlusOp = "PlusOp" | opname A.MinusOp = "MinusOp"
     | opname A.TimesOp = "TimesOp" | opname A.DivideOp = "DivideOp"
     | opname A.EqOp = "EqOp" | opname A.NeqOp = "NeqOp"
     | opname A.LtOp = "LtOp" | opname A.LeOp = "LeOp"
     | opname A.GtOp = "GtOp" | opname A.GeOp = "GeOp"
  ...
  and exp(A.VarExp v, d) = (indent d; sayln "VarExp("; var(v,d+1); say ")")
    ...
    | exp(A.SeqExp l, d) = ( indent d; say "SeqExp["
